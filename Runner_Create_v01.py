...
print('  Enter Module Number of Switch:')
iMod = input()
...
with open(iDcp + '_002_VPC_BUILD_runner.csv', 'w+') as file:
...
with open(iDcp + '_003_VPC_LIP_runner.csv', 'w+') as file:
    ...
    for i in range (iTvpc):
        ...
        myFile.writerow([switch_lip, iDcp, vpc_is, vpcLipg, int_desc, str(i + 1), str(i + iStep)])
